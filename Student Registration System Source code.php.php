...
<body>
  <div id="bar">   
    <ul>
      ...
      <li><a href="login.html" style="background-color: rgb(54, 163, 59); padding: 5px 15px;">Logout</a></li>
    </ul>    
  </div>
    ...
    <form action="#" method="post">
      ...
      <?php
        ...
        if(isset($_POST['register'])){
          ...
          $sql = "INSERT INTO student (id, fname, lname, age, sex, email, phone, course, birth_date) 
          VALUES ('$id','$fname','$lname','$age','$sex', '$email','$phone','$course','$dob')";
          $result = $conn->query($sql);

          if($result) {
            $sqlDisplay = "SELECT * FROM student";
            $resultDisplay = $conn->query($sqlDisplay);
            $row = mysqli_num_rows($resultDisplay);
            ...
            echo "data could not be inserted or Duplicate ID!. Please try again.";
          }
        }
      ?>
    </form>
